...
class TCM(CompressionModel):
    def __init__(self, N=128,  M=320, config=[2, 2, 2, 2, 2, 2], head_dim=[8, 16, 32, 32, 16, 8], drop_path_rate=0, num_slices=5, max_support_slices=5, **kwargs):
    ...
    @classmethod
    def from_state_dict(cls, state_dict, strict):
