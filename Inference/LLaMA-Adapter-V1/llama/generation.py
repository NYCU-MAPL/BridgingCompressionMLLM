    ...
    def generate(
        ...
        if imgs is not None and self.vision_model is not None:
            ...
            if token_noise is not None:
                vision_tokens, token_mse = self.vision_model(imgs, start_layer, token_noise, ori_image)
            else:
                vision_tokens = self.vision_model(imgs, start_layer)
