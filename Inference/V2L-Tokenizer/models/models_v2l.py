...
import models.global_encoder.CLIP_modify.clip as clip_modify
...
class VQModel_LLaMA(pl.LightningModule):
    def __init__(self,
        ...
        clip_encoder, _ = clip_modify.load("ViT-L/14")
    ...
    def forward(self, input, global_input, data_iter_step, step=0, is_val=False, k=21, start_layer = 0):
        
        
        with torch.no_grad():
            global_c_features, _ = self.global_encoder(global_input.half(), start_layer = start_layer) # CLIP ViT
